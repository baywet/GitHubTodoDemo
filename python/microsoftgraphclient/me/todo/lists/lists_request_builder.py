...
class ListsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(
        ...
        super().__init__(
            request_adapter,
            "{+baseurl}/me/todo/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}",
            path_parameters)
    ...
    async def get(
        ...
        request_configuration: Optional[
            ListsRequestBuilderGetRequestConfiguration] = None
    ...
    async def post(
        self,
        body: Optional[TodoTaskList] = None,
        request_configuration: Optional[
            ListsRequestBuilderPostRequestConfiguration] = None
    ...
    class ListsRequestBuilderGetRequestConfiguration(BaseRequestConfiguration):
        ...
        query_parameters: Optional[
            ListsRequestBuilder.ListsRequestBuilderGetQueryParameters] = None
