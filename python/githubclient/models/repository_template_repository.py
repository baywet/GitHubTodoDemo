...
class Repository_template_repository(AdditionalDataHolder, Parsable):
    ...
    merge_commit_message: Optional[Repository_template_repository_merge_commit_message] = None
    # The default value for a merge commit title.- `PR_TITLE` - default to the pull request's title.- `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
    merge_commit_title: Optional[Repository_template_repository_merge_commit_title] = None
    ...
    squash_merge_commit_message: Optional[Repository_template_repository_squash_merge_commit_message] = None
    # The default value for a squash merge commit title:- `PR_TITLE` - default to the pull request's title.- `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
    squash_merge_commit_title: Optional[Repository_template_repository_squash_merge_commit_title] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> Repository_template_repository:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "merge_commit_message": lambda n : setattr(self, 'merge_commit_message', n.get_enum_value(Repository_template_repository_merge_commit_message)),
            "merge_commit_title": lambda n : setattr(self, 'merge_commit_title', n.get_enum_value(Repository_template_repository_merge_commit_title)),
            ...
            "owner": lambda n : setattr(self, 'owner', n.get_object_value(Repository_template_repository_owner)),
            "permissions": lambda n : setattr(self, 'permissions', n.get_object_value(Repository_template_repository_permissions)),
            "private": lambda n : setattr(self, 'private', n.get_bool_value()),
            "pulls_url": lambda n : setattr(self, 'pulls_url', n.get_str_value()),
            "pushed_at": lambda n : setattr(self, 'pushed_at', n.get_str_value()),
            "releases_url": lambda n : setattr(self, 'releases_url', n.get_str_value()),
            "size": lambda n : setattr(self, 'size', n.get_int_value()),
            "squash_merge_commit_message": lambda n : setattr(self, 'squash_merge_commit_message', n.get_enum_value(Repository_template_repository_squash_merge_commit_message)),
            "squash_merge_commit_title": lambda n : setattr(self, 'squash_merge_commit_title', n.get_enum_value(Repository_template_repository_squash_merge_commit_title)),
