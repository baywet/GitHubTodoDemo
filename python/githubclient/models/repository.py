...
if TYPE_CHECKING:
    ...
    from .repository_merge_commit_message import Repository_merge_commit_message
    from .repository_merge_commit_title import Repository_merge_commit_title
    from .repository_permissions import Repository_permissions
    from .repository_squash_merge_commit_message import Repository_squash_merge_commit_message
    from .repository_squash_merge_commit_title import Repository_squash_merge_commit_title
...
class Repository(AdditionalDataHolder, Parsable):
    ...
    merge_commit_message: Optional[Repository_merge_commit_message] = None
    # The default value for a merge commit title.- `PR_TITLE` - default to the pull request's title.- `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
    merge_commit_title: Optional[Repository_merge_commit_title] = None
    ...
    permissions: Optional[Repository_permissions] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> Repository:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("allow_forking", self.allow_forking)
        ...
        writer.write_int_value("forks", self.forks)
        ...
        writer.write_bool_value("has_discussions", self.has_discussions)
