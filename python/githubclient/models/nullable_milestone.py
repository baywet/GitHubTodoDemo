...
class NullableMilestone(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> NullableMilestone:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "closed_issues": lambda n : setattr(self, 'closed_issues', n.get_int_value()),
            "created_at": lambda n : setattr(self, 'created_at', n.get_datetime_value()),
            "creator": lambda n : setattr(self, 'creator', n.get_object_value(NullableSimpleUser)),
            "description": lambda n : setattr(self, 'description', n.get_str_value()),
            "due_on": lambda n : setattr(self, 'due_on', n.get_datetime_value()),
            ...
            "state": lambda n : setattr(self, 'state', n.get_enum_value(NullableMilestone_state)),
