package githubtododemo.microsoftgraphclient.me.todo.lists;
...
import githubtododemo.microsoftgraphclient.me.todo.lists.item.TodoTaskListItemRequestBuilder;
import githubtododemo.microsoftgraphclient.models.odataerrors.ODataError;
import githubtododemo.microsoftgraphclient.models.TodoTaskList;
import githubtododemo.microsoftgraphclient.models.TodoTaskListCollectionResponse;
...
public class ListsRequestBuilder extends BaseRequestBuilder {
    ...
    public ListsRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/todo/lists{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters);
    }
    /**
     * Instantiates a new {@link ListsRequestBuilder} and sets the default values.
    ...
    public ListsRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/me/todo/lists{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl);
    }
    /**
