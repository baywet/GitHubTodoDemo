...
public class PullRequestHeadUser implements Parsable {
    ...
    public static PullRequestHeadUser createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullRequestHeadUser();
    }
    /**
