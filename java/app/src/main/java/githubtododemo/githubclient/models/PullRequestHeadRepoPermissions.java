...
public class PullRequestHeadRepoPermissions implements Parsable {
    /** The admin property */
    ...
    public static PullRequestHeadRepoPermissions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullRequestHeadRepoPermissions();
    }
    /**
