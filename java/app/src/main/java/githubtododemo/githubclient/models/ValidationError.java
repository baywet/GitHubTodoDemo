...
public class ValidationError extends ApiException implements Parsable {
    ...
    public static ValidationError createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     */
    @javax.annotation.Nonnull
    public void setErrors(@javax.annotation.Nullable final java.util.List<ValidationErrorErrors> value) {
        this.errors = value;
    }
    /**
