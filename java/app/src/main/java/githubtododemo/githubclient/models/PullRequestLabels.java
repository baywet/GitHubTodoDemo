...
public class PullRequestLabels implements Parsable {
    /** The color property */
    ...
    public static PullRequestLabels createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullRequestLabels();
    }
    /**
