...
public class RepositoryTemplateRepositoryPermissions implements Parsable {
    /**
     * The admin property
     */
    ...
    public static RepositoryTemplateRepositoryPermissions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new RepositoryTemplateRepositoryPermissions();
    }
    /**
