...
public class PullRequestHeadRepoOwner implements Parsable {
    ...
    public static PullRequestHeadRepoOwner createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullRequestHeadRepoOwner();
    }
    /**
