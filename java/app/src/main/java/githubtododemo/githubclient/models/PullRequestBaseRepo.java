...
public class PullRequestBaseRepo implements Parsable {
    ...
    private PullRequestBaseRepoPermissions permissions;
    ...
    public static PullRequestBaseRepo createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullRequestBaseRepo();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("owner", (n) -> { this.setOwner(n.getObjectValue(PullRequestBaseRepoOwner::createFromDiscriminatorValue)); });
        deserializerMap.put("permissions", (n) -> { this.setPermissions(n.getObjectValue(PullRequestBaseRepoPermissions::createFromDiscriminatorValue)); });
     ...
     * @return a PullRequestBaseRepoOwner
     */
    @javax.annotation.Nullable
     ...
     * @return a PullRequestBaseRepoPermissions
     */
    @javax.annotation.Nullable
    public PullRequestBaseRepoPermissions getPermissions() {
     ...
     */
    @javax.annotation.Nonnull
    public void setOwner(@javax.annotation.Nullable final PullRequestBaseRepoOwner value) {
        this.owner = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setPermissions(@javax.annotation.Nullable final PullRequestBaseRepoPermissions value) {
