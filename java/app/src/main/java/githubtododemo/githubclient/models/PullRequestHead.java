...
public class PullRequestHead implements Parsable {
    /** The label property */
    ...
    public static PullRequestHead createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("repo", (n) -> { this.setRepo(n.getObjectValue(PullRequestHeadRepo::createFromDiscriminatorValue)); });
        deserializerMap.put("sha", (n) -> { this.setSha(n.getStringValue()); });
        deserializerMap.put("user", (n) -> { this.setUser(n.getObjectValue(PullRequestHeadUser::createFromDiscriminatorValue)); });
     ...
     * @return a PullRequestHeadUser
     */
    @javax.annotation.Nullable
    public PullRequestHeadUser getUser() {
        return this.user;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setRepo(@javax.annotation.Nullable final PullRequestHeadRepo value) {
        this.repo = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setUser(@javax.annotation.Nullable final PullRequestHeadUser value) {
        this.user = value;
    }
}
