...
public class PullRequestBaseRepoOwner implements Parsable {
    ...
    public static PullRequestBaseRepoOwner createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullRequestBaseRepoOwner();
    }
    /**
