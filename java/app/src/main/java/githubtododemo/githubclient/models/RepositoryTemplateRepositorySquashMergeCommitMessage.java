...
public enum RepositoryTemplateRepositorySquashMergeCommitMessage implements ValuedEnum {
    ...
    RepositoryTemplateRepositorySquashMergeCommitMessage(final String value) {
        this.value = value;
    }
    @jakarta.annotation.Nonnull
    public String getValue() { return this.value; }
    @jakarta.annotation.Nullable
    public static RepositoryTemplateRepositorySquashMergeCommitMessage forValue(@jakarta.annotation.Nonnull final String searchValue) {
