...
public class PullRequestBaseRepoPermissions implements Parsable {
    /** The admin property */
    ...
    public static PullRequestBaseRepoPermissions createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullRequestBaseRepoPermissions();
    }
    /**
