...
class Repository_template_repository_owner implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return Repository_template_repository_owner
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Repository_template_repository_owner {
