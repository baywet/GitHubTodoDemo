 ...
 * Pull Request Simple
*/
class PullRequestSimple implements AdditionalDataHolder, Parsable 
{
    /**
     * @var PullRequestSimple__links|null $_links The _links property
    */
    private ?PullRequestSimple__links $_links = null;
    ...
    */
    ...
    /**
     * @var PullRequestSimple_base|null $base The base property
    */
    private ?PullRequestSimple_base $base = null;
    ...
    */
    ...
    /**
     * @var PullRequestSimple_head|null $head The head property
    */
    private ?PullRequestSimple_head $head = null;
    ...
    */
    ...
    /**
     * @var array<PullRequestSimple_labels>|null $labels The labels property
    */
    ...
    */
    ...
    /**
     * @var array<Team>|null $requested_teams The requested_teams property
    */
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequestSimple {
    ...
    */
     ...
     * @return PullRequestSimple_base|null
    */
    public function getBase(): ?PullRequestSimple_base {
        return $this->base;
    }
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            '_links' => fn(ParseNode $n) => $o->setlinks($n->getObjectValue([PullRequestSimple__links::class, 'createFromDiscriminatorValue'])),
            ...
            'base' => fn(ParseNode $n) => $o->setBase($n->getObjectValue([PullRequestSimple_base::class, 'createFromDiscriminatorValue'])),
            ...
            'head' => fn(ParseNode $n) => $o->setHead($n->getObjectValue([PullRequestSimple_head::class, 'createFromDiscriminatorValue'])),
            ...
            'labels' => fn(ParseNode $n) => $o->setLabels($n->getCollectionOfObjectValues([PullRequestSimple_labels::class, 'createFromDiscriminatorValue'])),
            ...
            'requested_teams' => fn(ParseNode $n) => $o->setRequestedTeams($n->getCollectionOfObjectValues([Team::class, 'createFromDiscriminatorValue'])),
     ...
     * @return PullRequestSimple_head|null
    */
    public function getHead(): ?PullRequestSimple_head {
        return $this->head;
    }
    ...
    */
     ...
     * @return array<PullRequestSimple_labels>|null
    */
     ...
     * @return PullRequestSimple__links|null
    */
    public function getlinks(): ?PullRequestSimple__links {
        return $this->_links;
    }
    ...
    */
     ...
     * @param PullRequestSimple_base|null $value Value to set for the base property.
    */
    public function setBase(?PullRequestSimple_base $value): void {
        $this->base = $value;
    }
    ...
    */
     ...
     * @param PullRequestSimple_head|null $value Value to set for the head property.
    */
    public function setHead(?PullRequestSimple_head $value): void {
        $this->head = $value;
    }
    ...
    */
     ...
     * @param array<PullRequestSimple_labels>|null $value Value to set for the labels property.
    */
     ...
     * @param PullRequestSimple__links|null $value Value to set for the _links property.
    */
    public function setlinks(?PullRequestSimple__links $value): void {
        $this->_links = $value;
    }
    ...
    */
     ...
     * @param array<Team>|null $value Value to set for the requested_teams property.
    */
