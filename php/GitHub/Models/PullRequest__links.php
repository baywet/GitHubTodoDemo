...
class PullRequest__links implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequest__links
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest__links {
