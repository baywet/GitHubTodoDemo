...
class MinimalRepository_license implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return MinimalRepository_license
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MinimalRepository_license {
