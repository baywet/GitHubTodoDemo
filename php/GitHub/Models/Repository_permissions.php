...
class Repository_permissions implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Repository_permissions {
