...
*/
class Repository implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var bool|null $allow_auto_merge Whether to allow Auto-merge to be used on pull requests.
    */
    private ?bool $allow_auto_merge = null;
    
    /**
     * @var bool|null $allow_forking Whether to allow forking this repo
    */
    private ?bool $allow_forking = null;
    
    /**
     * @var bool|null $allow_merge_commit Whether to allow merge commits for pull requests.
    */
    private ?bool $allow_merge_commit = null;
    
    /**
     * @var bool|null $allow_rebase_merge Whether to allow rebase merges for pull requests.
    */
    private ?bool $allow_rebase_merge = null;
    
    /**
     * @var bool|null $allow_squash_merge Whether to allow squash merges for pull requests.
    */
    private ?bool $allow_squash_merge = null;
    
    /**
     * @var bool|null $allow_update_branch Whether or not a pull request head branch that is behind its base branch can always be updated even if it is not required to be up to date before merging.
    */
    private ?bool $allow_update_branch = null;
    
    /**
     * @var bool|null $anonymous_access_enabled Whether anonymous git access is enabled for this repository
    */
    ...
    */
    ...
    /**
     * @var bool|null $archived Whether the repository is archived.
    */
    ...
    */
    ...
    /**
     * @var string|null $default_branch The default branch of the repository.
    */
    private ?string $default_branch = null;
    
    /**
     * @var bool|null $delete_branch_on_merge Whether to delete head branches when pull requests are merged
    */
    ...
    */
    ...
    /**
     * @var bool|null $disabled Returns whether or not this repository disabled.
    */
    ...
    */
    ...
    /**
     * @var bool|null $escapedPrivate Whether the repository is private or public.
    */
    ...
    */
    ...
    /**
     * @var bool|null $has_discussions Whether discussions are enabled.
    */
    private ?bool $has_discussions = null;
    
    /**
     * @var bool|null $has_downloads Whether downloads are enabled.
    */
    private ?bool $has_downloads = null;
    
    /**
     * @var bool|null $has_issues Whether issues are enabled.
    */
    ...
    */
    ...
    /**
     * @var bool|null $has_projects Whether projects are enabled.
    */
    private ?bool $has_projects = null;
    
    /**
     * @var bool|null $has_wiki Whether the wiki is enabled.
    */
    ...
    */
    ...
    /**
     * @var int|null $id Unique identifier of the repository
    */
    private ?int $id = null;
    
    /**
     * @var bool|null $is_template Whether this repository acts as a template that can be used to generate new repositories.
    */
    ...
    */
    ...
    /**
     * @var NullableLicenseSimple|null $license License Simple
    */
    ...
    */
    ...
    /**
     * @var Repository_merge_commit_message|null $merge_commit_message The default value for a merge commit message.- `PR_TITLE` - default to the pull request's title.- `PR_BODY` - default to the pull request's body.- `BLANK` - default to a blank commit message.
    */
    private ?Repository_merge_commit_message $merge_commit_message = null;
    
    /**
     * @var Repository_merge_commit_title|null $merge_commit_title The default value for a merge commit title.- `PR_TITLE` - default to the pull request's title.- `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
    */
    private ?Repository_merge_commit_title $merge_commit_title = null;
    ...
    */
    ...
    /**
     * @var string|null $name The name of the repository.
    */
    ...
    */
    ...
    /**
     * @var NullableSimpleUser|null $organization A GitHub user.
    */
    ...
    */
    ...
    /**
     * @var Repository_permissions|null $permissions The permissions property
    */
    private ?Repository_permissions $permissions = null;
    ...
    */
    ...
    /**
     * @var int|null $size The size of the repository. Size is calculated hourly. When a repository is initially created, the size is 0.
    */
    private ?int $size = null;
    
    /**
     * @var Repository_squash_merge_commit_message|null $squash_merge_commit_message The default value for a squash merge commit message:- `PR_BODY` - default to the pull request's body.- `COMMIT_MESSAGES` - default to the branch's commit messages.- `BLANK` - default to a blank commit message.
    */
    private ?Repository_squash_merge_commit_message $squash_merge_commit_message = null;
    
    /**
     * @var Repository_squash_merge_commit_title|null $squash_merge_commit_title The default value for a squash merge commit title:- `PR_TITLE` - default to the pull request's title.- `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
    */
    private ?Repository_squash_merge_commit_title $squash_merge_commit_title = null;
    ...
    */
    ...
    /**
     * @var string|null $starred_at The starred_at property
    */
    ...
    */
    ...
    /**
     * @var Repository_template_repository|null $template_repository The template_repository property
    */
    private ?Repository_template_repository $template_repository = null;
    ...
    */
    ...
    /**
     * @var bool|null $use_squash_pr_title_as_default Whether a squash merge commit can use the pull request title as default. **This property has been deprecated. Please use `squash_merge_commit_title` instead.
    */
    ...
    */
    ...
    /**
     * @var bool|null $web_commit_signoff_required Whether to require contributors to sign off on web-based commits
    */
    ...
    */
     ...
     * @return Repository
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Repository {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'anonymous_access_enabled' => fn(ParseNode $n) => $o->setAnonymousAccessEnabled($n->getBooleanValue()),
            ...
            'license' => fn(ParseNode $n) => $o->setLicense($n->getObjectValue([NullableLicenseSimple::class, 'createFromDiscriminatorValue'])),
            'master_branch' => fn(ParseNode $n) => $o->setMasterBranch($n->getStringValue()),
            'merge_commit_message' => fn(ParseNode $n) => $o->setMergeCommitMessage($n->getEnumValue(Repository_merge_commit_message::class)),
            'merge_commit_title' => fn(ParseNode $n) => $o->setMergeCommitTitle($n->getEnumValue(Repository_merge_commit_title::class)),
            ...
            'organization' => fn(ParseNode $n) => $o->setOrganization($n->getObjectValue([NullableSimpleUser::class, 'createFromDiscriminatorValue'])),
            'owner' => fn(ParseNode $n) => $o->setOwner($n->getObjectValue([SimpleUser::class, 'createFromDiscriminatorValue'])),
            'permissions' => fn(ParseNode $n) => $o->setPermissions($n->getObjectValue([Repository_permissions::class, 'createFromDiscriminatorValue'])),
            ...
            'squash_merge_commit_message' => fn(ParseNode $n) => $o->setSquashMergeCommitMessage($n->getEnumValue(Repository_squash_merge_commit_message::class)),
            'squash_merge_commit_title' => fn(ParseNode $n) => $o->setSquashMergeCommitTitle($n->getEnumValue(Repository_squash_merge_commit_title::class)),
            ...
            'starred_at' => fn(ParseNode $n) => $o->setStarredAt($n->getStringValue()),
            ...
            'template_repository' => fn(ParseNode $n) => $o->setTemplateRepository($n->getObjectValue([Repository_template_repository::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return NullableLicenseSimple|null
    */
    public function getLicense(): ?NullableLicenseSimple {
        return $this->license;
    }
    ...
    */
     ...
     * @return Repository_merge_commit_message|null
    */
    public function getMergeCommitMessage(): ?Repository_merge_commit_message {
     ...
     * @return Repository_merge_commit_title|null
    */
    public function getMergeCommitTitle(): ?Repository_merge_commit_title {
    ...
    */
    public function getOrganization(): ?NullableSimpleUser {
    ...
    */
     ...
     * @return Repository_permissions|null
    */
    public function getPermissions(): ?Repository_permissions {
    ...
    */
     ...
     * @return Repository_squash_merge_commit_message|null
    */
    public function getSquashMergeCommitMessage(): ?Repository_squash_merge_commit_message {
     ...
     * @return Repository_squash_merge_commit_title|null
    */
    public function getSquashMergeCommitTitle(): ?Repository_squash_merge_commit_title {
    ...
    */
     ...
     * @return Repository_template_repository|null
    */
    public function getTemplateRepository(): ?Repository_template_repository {
    ...
    */
     ...
     * @param bool|null $value Value to set for the anonymous_access_enabled property.
    */
    public function setAnonymousAccessEnabled(?bool $value): void {
        $this->anonymous_access_enabled = $value;
    }
    ...
    */
     ...
     * @param NullableLicenseSimple|null $value Value to set for the license property.
    */
    public function setLicense(?NullableLicenseSimple $value): void {
        $this->license = $value;
    }
    ...
    */
     ...
     * @param Repository_merge_commit_message|null $value Value to set for the merge_commit_message property.
    */
    public function setMergeCommitMessage(?Repository_merge_commit_message $value): void {
     ...
     * @param Repository_merge_commit_title|null $value Value to set for the merge_commit_title property.
    */
    public function setMergeCommitTitle(?Repository_merge_commit_title $value): void {
    ...
    */
     ...
     * @param NullableSimpleUser|null $value Value to set for the organization property.
    */
    public function setOrganization(?NullableSimpleUser $value): void {
    ...
    */
     ...
     * @param Repository_permissions|null $value Value to set for the permissions property.
    */
    public function setPermissions(?Repository_permissions $value): void {
    ...
    */
     ...
     * @param Repository_squash_merge_commit_message|null $value Value to set for the squash_merge_commit_message property.
    */
    public function setSquashMergeCommitMessage(?Repository_squash_merge_commit_message $value): void {
     ...
     * @param Repository_squash_merge_commit_title|null $value Value to set for the squash_merge_commit_title property.
    */
    public function setSquashMergeCommitTitle(?Repository_squash_merge_commit_title $value): void {
    ...
    */
     ...
     * @param string|null $value Value to set for the starred_at property.
    */
    public function setStarredAt(?string $value): void {
        $this->starred_at = $value;
    }
    ...
    */
     ...
     * @param Repository_template_repository|null $value Value to set for the template_repository property.
    */
    public function setTemplateRepository(?Repository_template_repository $value): void {
        $this->template_repository = $value;
    }
