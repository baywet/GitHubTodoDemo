...
class PullRequest_base_repo implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var PullRequest_base_repo_owner|null $owner The owner property
    */
    private ?PullRequest_base_repo_owner $owner = null;
    
    /**
     * @var PullRequest_base_repo_permissions|null $permissions The permissions property
    */
    private ?PullRequest_base_repo_permissions $permissions = null;
    ...
    */
     ...
     * @return PullRequest_base_repo
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest_base_repo {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'owner' => fn(ParseNode $n) => $o->setOwner($n->getObjectValue([PullRequest_base_repo_owner::class, 'createFromDiscriminatorValue'])),
            'permissions' => fn(ParseNode $n) => $o->setPermissions($n->getObjectValue([PullRequest_base_repo_permissions::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return PullRequest_base_repo_owner|null
    */
    public function getOwner(): ?PullRequest_base_repo_owner {
        return $this->owner;
    }

    /**
     * Gets the permissions property value. The permissions property
     * @return PullRequest_base_repo_permissions|null
    */
    public function getPermissions(): ?PullRequest_base_repo_permissions {
    ...
    */
     ...
     * @param PullRequest_base_repo_owner|null $value Value to set for the owner property.
    */
    public function setOwner(?PullRequest_base_repo_owner $value): void {
        $this->owner = $value;
    }

    /**
     * Sets the permissions property value. The permissions property
     * @param PullRequest_base_repo_permissions|null $value Value to set for the permissions property.
    */
    public function setPermissions(?PullRequest_base_repo_permissions $value): void {
