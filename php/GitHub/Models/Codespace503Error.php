...
class Codespace503Error extends ApiException implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return Codespace503Error
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Codespace503Error {
