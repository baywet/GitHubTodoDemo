...
class WithReview_PutRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return WithReview_PutRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): WithReview_PutRequestBody {
