...
class Requested_reviewersPostRequestBody implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var array<string>|null $reviewers An array of user `login`s that will be requested.
    */
    private ?array $reviewers = null;
    
    /**
     * @var array<string>|null $team_reviewers An array of team `slug`s that will be requested.
    */
    ...
    */
     ...
     * @return Requested_reviewersPostRequestBody
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Requested_reviewersPostRequestBody {
    ...
    */
    ...
    /**
     * Gets the reviewers property value. An array of user `login`s that will be requested.
    ...
    */
    ...
    /**
     * Gets the team_reviewers property value. An array of team `slug`s that will be requested.
     * @return array<string>|null
    */
    ...
    */
    ...
    /**
     * Sets the reviewers property value. An array of user `login`s that will be requested.
    ...
    */
    ...
    /**
     * Sets the team_reviewers property value. An array of team `slug`s that will be requested.
