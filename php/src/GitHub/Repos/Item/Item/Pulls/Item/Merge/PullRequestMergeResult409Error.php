...
class PullRequestMergeResult409Error extends ApiException implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequestMergeResult409Error
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequestMergeResult409Error {
