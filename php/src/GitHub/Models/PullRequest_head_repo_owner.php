...
class PullRequest_head_repo_owner implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequest_head_repo_owner
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest_head_repo_owner {
