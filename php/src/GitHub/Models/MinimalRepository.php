 ...
 * Minimal Repository
*/
class MinimalRepository implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
    ...
    /**
     * @var CodeOfConduct|null $code_of_conduct Code Of Conduct
    */
    private ?CodeOfConduct $code_of_conduct = null;
    ...
    */
    ...
    /**
     * @var MinimalRepository_license|null $license The license property
    */
    private ?MinimalRepository_license $license = null;
    ...
    */
    ...
    /**
     * @var MinimalRepository_permissions|null $permissions The permissions property
    */
    private ?MinimalRepository_permissions $permissions = null;
    ...
    */
    ...
    /**
     * @var string|null $role_name The role_name property
    */
    private ?string $role_name = null;
    
    /**
     * @var SecurityAndAnalysis|null $security_and_analysis The security_and_analysis property
    */
    private ?SecurityAndAnalysis $security_and_analysis = null;
    ...
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MinimalRepository {
    ...
    */
    ...
    /**
     * Gets the code_of_conduct property value. Code Of Conduct
     * @return CodeOfConduct|null
    */
    public function getCodeOfConduct(): ?CodeOfConduct {
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'code_of_conduct' => fn(ParseNode $n) => $o->setCodeOfConduct($n->getObjectValue([CodeOfConduct::class, 'createFromDiscriminatorValue'])),
            ...
            'license' => fn(ParseNode $n) => $o->setLicense($n->getObjectValue([MinimalRepository_license::class, 'createFromDiscriminatorValue'])),
            ...
            'permissions' => fn(ParseNode $n) => $o->setPermissions($n->getObjectValue([MinimalRepository_permissions::class, 'createFromDiscriminatorValue'])),
            ...
            'role_name' => fn(ParseNode $n) => $o->setRoleName($n->getStringValue()),
            'security_and_analysis' => fn(ParseNode $n) => $o->setSecurityAndAnalysis($n->getObjectValue([SecurityAndAnalysis::class, 'createFromDiscriminatorValue'])),
    ...
    */
     ...
     * @return MinimalRepository_license|null
    */
    public function getLicense(): ?MinimalRepository_license {
        return $this->license;
    }
    ...
    */
     ...
     * @return MinimalRepository_permissions|null
    */
    public function getPermissions(): ?MinimalRepository_permissions {
    ...
    */
    ...
    /**
     * Gets the role_name property value. The role_name property
     * @return string|null
    */
    ...
    /**
     * Gets the security_and_analysis property value. The security_and_analysis property
     * @return SecurityAndAnalysis|null
    */
    public function getSecurityAndAnalysis(): ?SecurityAndAnalysis {
    ...
    */
    public function serialize(SerializationWriter $writer): void {
        ...
        $writer->writeObjectValue('code_of_conduct', $this->getCodeOfConduct());
        ...
        $writer->writeStringValue('role_name', $this->getRoleName());
        $writer->writeObjectValue('security_and_analysis', $this->getSecurityAndAnalysis());
    ...
    */
    ...
    /**
     * Sets the code_of_conduct property value. Code Of Conduct
     * @param CodeOfConduct|null $value Value to set for the code_of_conduct property.
    */
    public function setCodeOfConduct(?CodeOfConduct $value): void {
        $this->code_of_conduct = $value;
    }
    ...
    */
     ...
     * @param MinimalRepository_license|null $value Value to set for the license property.
    */
    public function setLicense(?MinimalRepository_license $value): void {
        $this->license = $value;
    }
    ...
    */
     ...
     * @param MinimalRepository_permissions|null $value Value to set for the permissions property.
    */
    public function setPermissions(?MinimalRepository_permissions $value): void {
    ...
    */
    ...
    /**
     * Sets the role_name property value. The role_name property
     * @param string|null $value Value to set for the role_name property.
    */
    ...
    /**
     * Sets the security_and_analysis property value. The security_and_analysis property
     * @param SecurityAndAnalysis|null $value Value to set for the security_and_analysis property.
    */
    public function setSecurityAndAnalysis(?SecurityAndAnalysis $value): void {
        $this->security_and_analysis = $value;
    }
