...
class Repository_template_repository_permissions implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return Repository_template_repository_permissions
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): Repository_template_repository_permissions {
