...
class PullRequest_head_user implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequest_head_user
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest_head_user {
