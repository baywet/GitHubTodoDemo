...
class PullRequest503Error extends ApiException implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequest503Error
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest503Error {
