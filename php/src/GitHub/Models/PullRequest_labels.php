...
class PullRequest_labels implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequest_labels
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest_labels {
