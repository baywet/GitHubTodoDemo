...
class PullRequestReview__links_pull_request implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequestReview__links_pull_request
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequestReview__links_pull_request {
