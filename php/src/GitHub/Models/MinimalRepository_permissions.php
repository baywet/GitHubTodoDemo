...
class MinimalRepository_permissions implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return MinimalRepository_permissions
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): MinimalRepository_permissions {
