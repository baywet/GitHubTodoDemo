...
class PullRequest_base_user implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequest_base_user
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest_base_user {
