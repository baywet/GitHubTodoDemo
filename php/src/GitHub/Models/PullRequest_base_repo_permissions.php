...
class PullRequest_base_repo_permissions implements AdditionalDataHolder, Parsable 
{
    /**
    ...
    */
     ...
     * @return PullRequest_base_repo_permissions
    */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): PullRequest_base_repo_permissions {
