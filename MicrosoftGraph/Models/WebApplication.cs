...
namespace GitHubTodoDemo.MicrosoftGraph.Models {
    public class WebApplication : IAdditionalDataHolder, IParsable {
        ...
        public GitHubTodoDemo.MicrosoftGraph.Models.ImplicitGrantSettings ImplicitGrantSettings { get; set; }
        ...
        public List<GitHubTodoDemo.MicrosoftGraph.Models.RedirectUriSettings> RedirectUriSettings { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"implicitGrantSettings", n => { ImplicitGrantSettings = n.GetObjectValue<GitHubTodoDemo.MicrosoftGraph.Models.ImplicitGrantSettings>(GitHubTodoDemo.MicrosoftGraph.Models.ImplicitGrantSettings.CreateFromDiscriminatorValue); } },
                {"logoutUrl", n => { LogoutUrl = n.GetStringValue(); } },
                {"@odata.type", n => { OdataType = n.GetStringValue(); } },
                {"redirectUris", n => { RedirectUris = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"redirectUriSettings", n => { RedirectUriSettings = n.GetCollectionOfObjectValues<GitHubTodoDemo.MicrosoftGraph.Models.RedirectUriSettings>(GitHubTodoDemo.MicrosoftGraph.Models.RedirectUriSettings.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<GitHubTodoDemo.MicrosoftGraph.Models.ImplicitGrantSettings>("implicitGrantSettings", ImplicitGrantSettings);
            ...
            writer.WriteCollectionOfObjectValues<GitHubTodoDemo.MicrosoftGraph.Models.RedirectUriSettings>("redirectUriSettings", RedirectUriSettings);
