...
namespace GithubTodoDemo.GitHub.Models {
    ...
    public class MinimalRepository : IAdditionalDataHolder, IParsable {
        ...
        public CodeOfConduct Code_of_conduct { get; set; }
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"code_of_conduct", n => { Code_of_conduct = n.GetObjectValue<CodeOfConduct>(CodeOfConduct.CreateFromDiscriminatorValue); } },
                ...
                {"role_name", n => { Role_name = n.GetStringValue(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<CodeOfConduct>("code_of_conduct", Code_of_conduct);
            ...
            writer.WriteStringValue("role_name", Role_name);
