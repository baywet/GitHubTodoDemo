...
using GithubTodoDemo.GitHub.Repos.Item.Item.Pulls.Item.Codespaces;
...
namespace GithubTodoDemo.GitHub.Repos.Item.Item.Pulls.Item {
    /// <summary>Builds and executes requests for operations under \repos\{owner}\{repo}\pulls\{pull_number}</summary>
    public class WithPull_numberItemRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<WithPull_numberItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(WithPull_numberPatchRequestBody body, Action<WithPull_numberItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
        ...
        /// </summary>
        public async Task<PullRequest> GetAsync(Action<WithPull_numberItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PullRequest> PatchAsync(WithPull_numberPatchRequestBody body, Action<WithPull_numberItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
