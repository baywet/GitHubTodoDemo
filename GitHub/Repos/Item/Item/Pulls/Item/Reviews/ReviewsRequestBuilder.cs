...
namespace GithubTodoDemo.GitHub.Repos.Item.Item.Pulls.Item.Reviews {
    ...
    public class ReviewsRequestBuilder {
        ...
        /// </summary>
        public async Task<List<PullRequestReview>> GetAsync(Action<ReviewsRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<PullRequestReview>(requestInfo, PullRequestReview.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PullRequestReview> PostAsync(ReviewsPostRequestBody body, Action<ReviewsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
